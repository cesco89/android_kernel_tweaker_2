...
import com.dsht.kerneltweaker.utils.CPUStateMonitor.CPUStateMonitorException;
import com.dsht.kerneltweaker.utils.CPUStateMonitor.CpuState;
import com.dsht.kerneltweaker.utils.Constants;
import com.dsht.kerneltweaker.utils.Helpers;
import com.dsht.kerneltweaker.widgets.ObservableFragment;

public class CpuStatsFragment extends ObservableFragment implements Constants {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup root, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.stats_layout, root, false);
        ...
        mCpuInfoList = (GridView) view.findViewById(R.id.cpu_info_list);
    ...
    public void onDestroy() {
        ...
        try {
            ...
            Log.d(TAG, "NOTHING TO DO HERE, GO AWAY! :D");
        }
    ...
    protected class RefreshStateDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void v) {
            updateView();
            mUpdatingData = false;
            CpuStatsFragment.this.getListener().onComplete();
        }
    }
